...
@Controller
@RequiredArgsConstructor // final이 붙은 필드의 생성자를 만들어주는 Lombok 어노테이션
public class UserController {
    private final UserRepository userRepository;


    // static/index.html => UserController의 leaf() 호출 -> templates/leaf.html 반환 -> 브라우저에 렌더링
